...
export const TOKENS_BY_CHAIN: Record<number, Token[]> = {
  [sepolia.id]: [
    ...
    },
    {
      symbol: 'USDT',
      name: 'Tether USD',
      logoURI: 'https://raw.githubusercontent.com/spothq/cryptocurrency-icons/master/svg/color/usdt.svg',
    ...
    },
    {
      symbol: 'USDC',
      name: 'USD Coin',
      logoURI: 'https://raw.githubusercontent.com/spothq/cryptocurrency-icons/master/svg/color/usdc.svg',
  ...
  [celoSepolia.id]: [
    {
      symbol: 'CELO',
      name: 'Celo',
      logoURI: 'https://raw.githubusercontent.com/spothq/cryptocurrency-icons/master/svg/color/celo.svg',
      address: NATIVE_TOKEN_ADDRESS,
      decimals: 18,
    },
     {
